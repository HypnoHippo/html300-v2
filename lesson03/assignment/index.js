// Bring over and parse the JSON data
const peopleJSON = `[
  {
    "name": "Paolo Maldini",
...
// Create a container for the cards we're about to make in the DOM
const container = document.querySelector(`#template-hook`)

// Creating a card template to generate each card from the JSON data
